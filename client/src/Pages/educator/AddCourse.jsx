        ...
        <div className="mt-8">
          {chapters.map((chapter, chapterIndex) =>(
            <div key={chapterIndex} className="bg-white border rounded-lg mb-4">
              <div className="flex justify-between items-center p-4 bordeer-b">
          ...
          <div className='flex justify-center items-center bg-blue-100 p-2 rounded-lg cursor-pointer mb-8' onClick={() => handleChapter('add')}>+ Add Chapter</div>
